...
namespace KaitReferences.Services
{
    public class Excel
    {
        const string COLUMNS = "`ФИО`, `Дата рождения`, `Пол`, `Финансирование (средства обучения)`, `Учебная группа`, `Курс обучения`, `Статус обучения`, `Базовое образование`, `Номер приказа о зачислении`, `Дата приказа о зачислении`, `Дата приема`, `Программа обучения`, `Профессия/специальность`, `Код профессии/специальности`, `Форма обучения`, `Срок обучения`";
